              ...
              return (
                ...
                >
                  <Box
                    component="img"
                    src={image}
                    alt={`${blog.title} - ${blog.categoryId?.name || blog.category || "Furniture"} in Charkhi Dadri Haryana`}
                    title={`${blog.title} - ${blog.categoryId?.name || blog.category || "Furniture"} in Charkhi Dadri Haryana`}
                    sx={{
                      width: "100%",
